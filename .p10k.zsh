# Generated by Powerlevel10k configuration wizard on 2026-08-13 at 13:21 IST.
...
# compact, few icons, concise, transient_prompt=always, instant_prompt=verbose.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIVIS_CONTENT_EXPANSION='󰦨'
  ...
  typeset -g POWERLEVEL9K_DIR_PREFIX="%{$(printf '\033')[3m%}"
  typeset -g POWERLEVEL9K_DIR_SUFFIX="%{$(printf '\033')[23m%}"
