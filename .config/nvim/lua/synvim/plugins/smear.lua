...
return {
  ...
  opts = {
    ...
    stiffness = 0.8, -- 0.6 to 1 (higher = faster catch up)
    trailing_stiffness = 0.5, -- Smear trail stiffness (lower = longer trail)
    ...
    transparent_bg_fallback_color = "#1e1e2e", -- Catppuccin base fallback
  },
