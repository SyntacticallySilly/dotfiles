...
'(--json -j --json-summary)-s[Show parsing statistics]' \
'(--json -j --json-summary)--stat[Show parsing statistics]' \
...
(( $+functions[_tree-sitter__subcmd__build_commands] )) ||
_tree-sitter__subcmd__build_commands() {
    local commands; commands=()
    _describe -t commands 'tree-sitter build commands' commands "$@"
}
(( $+functions[_tree-sitter__subcmd__complete_commands] )) ||
_tree-sitter__subcmd__complete_commands() {
    local commands; commands=()
    _describe -t commands 'tree-sitter complete commands' commands "$@"
}
(( $+functions[_tree-sitter__subcmd__dump-languages_commands] )) ||
_tree-sitter__subcmd__dump-languages_commands() {
    local commands; commands=()
    _describe -t commands 'tree-sitter dump-languages commands' commands "$@"
}
(( $+functions[_tree-sitter__subcmd__fuzz_commands] )) ||
_tree-sitter__subcmd__fuzz_commands() {
    local commands; commands=()
    _describe -t commands 'tree-sitter fuzz commands' commands "$@"
}
(( $+functions[_tree-sitter__subcmd__generate_commands] )) ||
_tree-sitter__subcmd__generate_commands() {
    local commands; commands=()
    _describe -t commands 'tree-sitter generate commands' commands "$@"
}
(( $+functions[_tree-sitter__subcmd__highlight_commands] )) ||
_tree-sitter__subcmd__highlight_commands() {
    local commands; commands=()
    _describe -t commands 'tree-sitter highlight commands' commands "$@"
}
(( $+functions[_tree-sitter__subcmd__init_commands] )) ||
_tree-sitter__subcmd__init_commands() {
    local commands; commands=()
    _describe -t commands 'tree-sitter init commands' commands "$@"
}
(( $+functions[_tree-sitter__subcmd__init-config_commands] )) ||
_tree-sitter__subcmd__init-config_commands() {
    local commands; commands=()
    _describe -t commands 'tree-sitter init-config commands' commands "$@"
}
(( $+functions[_tree-sitter__subcmd__parse_commands] )) ||
_tree-sitter__subcmd__parse_commands() {
    local commands; commands=()
    _describe -t commands 'tree-sitter parse commands' commands "$@"
}
(( $+functions[_tree-sitter__subcmd__playground_commands] )) ||
_tree-sitter__subcmd__playground_commands() {
    local commands; commands=()
    _describe -t commands 'tree-sitter playground commands' commands "$@"
}
(( $+functions[_tree-sitter__subcmd__query_commands] )) ||
_tree-sitter__subcmd__query_commands() {
    local commands; commands=()
    _describe -t commands 'tree-sitter query commands' commands "$@"
}
(( $+functions[_tree-sitter__subcmd__tags_commands] )) ||
_tree-sitter__subcmd__tags_commands() {
    local commands; commands=()
    _describe -t commands 'tree-sitter tags commands' commands "$@"
}
(( $+functions[_tree-sitter__subcmd__test_commands] )) ||
_tree-sitter__subcmd__test_commands() {
    local commands; commands=()
    _describe -t commands 'tree-sitter test commands' commands "$@"
}
(( $+functions[_tree-sitter__subcmd__version_commands] )) ||
_tree-sitter__subcmd__version_commands() {
    local commands; commands=()
